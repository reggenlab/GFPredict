...
train_y_mat[idx, 1:length(train_yout)] = train_yout; #saving the indices of train_yout
test_y_mat[idx, 1:length(test_yout)] = test_yout; #saving the indices of test_yout 
...
write.table(neg_matrix, file =neg_index)
write.table(train_y_mat, file =train_index)
write.table(test_y_mat, file=test_index)
