...
### Generateing results of random forest algorithm for first 295 ontological gene-sets from ontology file in **3 steps:** <a name="ontology_results"></a>
...
```shell
#move to the directory condtaining R script, functionalML.R
cd GFPredict/code/

#run the script functionalML.R.
